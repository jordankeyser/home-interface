        ...
        <div className="h-full w-full bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 p-4 flex flex-col shadow-xl relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={togglePause}
                        className={`p-1.5 rounded-full hover:bg-white/10 transition-all ${isPaused ? 'text-yellow-400' : 'text-gray-300 hover:text-blue-400'}`}
                    ...
                    <button
                        ...
                        className={`p-1.5 rounded-full hover:bg-white/10 transition-all ${loading ? 'animate-spin opacity-50' : 'hover:text-blue-400'}`}
                        title="Refresh Data"
                    >
